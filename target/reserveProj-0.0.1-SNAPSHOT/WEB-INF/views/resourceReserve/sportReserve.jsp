...
<div id="content" >
		<ul class="nav nav-tabs">
			<li class="active" data-toggle="tab" id="east"><a  onclick="javascript:window.location.href='${APP_PATH}/sport/resource?areaNum=3'">东区</a></li>
			<li data-toggle="tab" id="west"><a  onclick="javascript:window.location.href='${APP_PATH}/sport/resource?areaNum=2'">西区</a></li>
			<li data-toggle="tab" id="center"><a  onclick="javascript:window.location.href='${APP_PATH}/sport/resource?areaNum=1'">中区</a></li>
		</ul>
...
<form action="${APP_PATH}/sport/submitReserve" >
<div class="container">
	<table class="table-bordered">
		<input type="hidden" name="id" value="${timeArrange.id}"/>
		<input type="hidden" name="sportId" value="${sportsGround.id}"/>
		<input type="hidden" name="name" value="${sportsGround.name}"/>
		...
		<tr class="info" height="13%">
			...
			<td colspan="6" >
				<span class="textSize">${sportsGround.name }</span>
