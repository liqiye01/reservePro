...
<div id="box2" style="display: none">
	...
	<div id="content" class="">
		<ul class="nav nav-tabs">
			<li class="active" data-toggle="tab" id="east"><a  onclick="javascript:window.location.href='${APP_PATH}/sport/resource?areaNum=3&pageNum=${pageNum}'">东区</a></li>
			<li data-toggle="tab" id="west"><a  onclick="javascript:window.location.href='${APP_PATH}/sport/resource?areaNum=2&pageNum=${pageNum}'">西区</a></li>
			<li data-toggle="tab" id="center"><a  onclick="javascript:window.location.href='${APP_PATH}/sport/resource?areaNum=1&pageNum=${pageNum}'">中区</a></li>
		</ul>
			...
			<tbody style="width: 100%">
				<c:forEach items="${list}" var="sport">
					<tr>
						...
						<td>${sport.space }</td>
						<td>
							<a><a href="reserve?id=${sport.id}&areaNum=${areaNum}&pageNum=${pageNum}">预定详情 <span class="glyphicon glyphicon-hand-up"></span></a></a>
						</td>
					</tr>
				</c:forEach>			
			</tbody>
