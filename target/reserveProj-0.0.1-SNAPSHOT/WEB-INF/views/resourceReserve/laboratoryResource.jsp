...
<body>
	<div id="content" class="">
		<ul class="nav nav-tabs">
			<li class="active" ><a  onclick="javascript:window.location.href='${APP_PATH}/laboratory/resource">实验楼</a></li>
		</ul>
		...
		<c:forEach items="${BudNumList}" var="BudNum">
			<div class="main" >
				<table class="table">
					<thead>
						<tr class="row" >
							<td class="col-lg-2">${BudNum}号实验楼</td>
			...
			<div class="next">
       			<iframe src="${APP_PATH}/laboratory/details?buildingNum=${BudNum}" id="mainFrame" name="mainFrame" frameborder="0" width="100%"  height="500px" ></iframe> 
    		</div>
		</c:forEach>
