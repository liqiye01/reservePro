...
public class LaboratoryController {
	...
	public String laboratoryResource(){
		List<String> list = laboratoryService.findBuildingnum();
		request.setAttribute("BudNumList", list);
		return "resourceReserve/laboratoryResource";
	}
	...
	public String buildingDetails(String  buildingNum){
		...
		List<LaboratoryBuilding> list = laboratoryService.findLaboratoryByBuildingNum(i);
	...
	public String reserveDetails(String  id){
		LaboratoryBuilding laboratoryBuilding = laboratoryService.getById(id);
		...
		request.setAttribute("classroom", laboratoryBuilding);
		...
		request.setAttribute("laboratoryFlag", "1");
	...
	public String laboratorySubmitReserve(TimeArrange timeArrange){
		...
		String resourceName=buildingNum+"实"+roomNum;
				...
				if(o!=null && !o.equals("")){
					if(o.equals("yes")){
						...
						if(list.size()>0){
							...
							List<LaboratoryBuilding> list2 = laboratoryService.findLaboratoryByBuildingNum(num);
