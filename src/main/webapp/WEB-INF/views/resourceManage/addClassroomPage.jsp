...
<div id="content" >
	<ul class="nav nav-tabs">
		<li  data-toggle="tab" ><a  onclick="javascript:window.location.href='${APP_PATH}/manage/classroomListPage?pageNum=1'">资源列表</a></li>
		<c:if test="${classroom.id==null}">
			<li class="active" data-toggle="tab" ><a  onclick="javascript:window.location.href='${APP_PATH}/manage/addClassroomPage'">新增资源</a></li>
		</c:if>
		<c:if test="${classroom.id!=null}">
			<li class="active" data-toggle="tab" ><a  onclick="javascript:window.location.href='${APP_PATH}/manage/addClassroomPage'">资源修改</a></li>
		</c:if>
	</ul>
	<div class="addForm">
		<form:form modelAttribute="classroom"  action="${APP_PATH}/manage/addClassroom" method="post">
			<form:hidden path="id"/>
		   ...
		   <div class="form-group">
		    	<label for="exampleInputEmail1" class="text1"> 是否有空调</label></br>
