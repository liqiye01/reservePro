...
$(document).ready(function(){
	...
	if(${laboratoryBuilding.area=='1'}){
		$("#areaText").html("中区");
	}
	if(${laboratoryBuilding.area=='2'}){
		$("#areaText").html("西区");
	}
	if(${laboratoryBuilding.area=='3'}){
		$("#areaText").html("东区");
	}
	...
	<div id="content">
		<div >
  			...
  			<c:if test="${updateSuccess==null}">
  				<p class="text2">添加实验室: <strong>${resourceName}</strong></p>
  			</c:if>
...
<div id="content" >
	<ul class="nav nav-tabs">
		<li  data-toggle="tab" ><a  onclick="javascript:window.location.href='${APP_PATH}/manage/laboratoryListPage?pageNum=1'">资源列表</a></li>
		<c:if test="${laboratoryBuilding.id==null}">
			<li class="active" data-toggle="tab" ><a  onclick="javascript:window.location.href='${APP_PATH}/manage/addLaboratoryPage'">新增资源</a></li>
		</c:if>
		<c:if test="${laboratoryBuilding.id!=null}">
			<li class="active" data-toggle="tab" ><a  onclick="javascript:window.location.href='${APP_PATH}/manage/addLaboratoryPage'">资源修改</a></li>
		</c:if>
	</ul>
	<div class="addForm">
		<form:form modelAttribute="laboratoryBuilding"  action="${APP_PATH}/manage/addLaboratory" method="post">
			<form:hidden path="id"/>
			<div class="form-group">
		    	<label  class="text1"> 区域</label></br>
		   ...
		   <div class="form-group">
		    	<label  class="text1"> 实验楼号</label></br>
		   ...
		   <div class="form-group">
		    	<label  class="text1"> 房号</label></br>
				<form:input path="roomNum" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"
				 type="text" class="form-control"  placeholder="如101实验室请输入:101" style="width: 280px" />
		   </div>
		   <div class="form-group">
		    	<label  class="text1"> 最大容纳人数 (人)</label></br>
		   ...
		   <div class="form-group">
		    	<label  class="text1"> 是否有空调</label></br>
		    	<div style="margin:5px 10px;">
					<form:radiobutton   id="yes" path="airConditioner" value="1" checked="checked" />
	      			<label for="yes">是</label>
	      			<form:radiobutton   id="no" path="airConditioner" value="0" /> 
